...
module Apiary
  class CLI < Thor
    ...
    desc 'fetch', 'Fetch API Description from API_NAME.apiary.io'
    ...
    method_option :output, :type => :string, :banner => 'FILE', :desc => 'Write API Description into specified file'
    ...
    method_option :path, :type => :string, :desc => 'Specify path to API Description file. For directory it will look for apiary.apib or swagger.yaml file'
    method_option :api_host, :type => :string, :banner => 'HOST', :desc => 'Specify apiary host'
    ...
    desc 'publish', 'Publish API Description source on docs.API_NAME.apiary.io'
